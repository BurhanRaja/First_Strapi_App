  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded" src={product.image.data.attributes.name} />
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
            <div className="flex items-center">
              <span className="mr-3">Size: <b>{product.size}</b></span>
            </div>
          </div>
          <div className="flex">
...
export async function getServerSideProps(context) {
  ...
  const response = await fetch(`${host}api/products?filters[slug]=${context.query.slug}&populate=*`, {
      method: 'GET',
      headers: {
